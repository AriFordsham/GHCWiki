...
For Windows users, there's a [ chocolatey package](https://chocolatey.org/packages/arcanist) available, so to install it a simple `cinst -y arcanist` in an Admin shell will get you going.
