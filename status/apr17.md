...
\paragraph{Libraries, source language, and type system}\begin{itemize}\item\textbf{Indexed Typeable representations.} While GHC has long supported
...
\end{itemize}\paragraph{Runtime system}\begin{itemize}\item\textbf{Compact regions}. This runtime system feature allows a
...
\end{itemize}\paragraph{Miscellaneous}\begin{itemize}\item\textbf{Compiler Determinism.} GHC 8.0.2 is the first release of GHC
...
details.
\end{itemize}\subsubsection{Development updates and acknowledgments}
...
\FurtherReading\begin{itemize}\item GHC website:

     \url{https://haskell.org/ghc/}\item GHC users guide:

     \url{https://downloads.haskell.org/~ghc/master/users_guide/}\item\texttt{ghc-devs} mailing list:

     \url{https://mail.haskell.org/mailman/listinfo/ghc-devs}\end{itemize}
```