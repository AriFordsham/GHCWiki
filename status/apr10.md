...
- David Terei made a LLVM back end for GHC [ Terei](http://hackage.haskell.org/trac/ghc/wiki/Commentary/Compiler/Backends/LLVM)\].  It's not part of the HEAD, but we earnestly hope that it will become so.
