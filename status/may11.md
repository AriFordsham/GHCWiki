...
- In the autumn, Dimitrios and Simon PJ implemented a completely
  ...
  epic JFP paper describing how it works [ http://research.microsoft.com/en-us/um/people/simonpj/papers/constraints/ OutsideIn](http://research.microsoft.com/en-us/um/people/simonpj/papers/constraints/ OutsideIn).  The new
...
> FC, as described in our 2007 paper [ http://research.microsoft.com/en-us/um/people/simonpj/papers/ext-f/ FC](http://research.microsoft.com/en-us/um/people/simonpj/papers/ext-f/ FC).  However, the way that System FC
...
> equivalent smaller ones. All this is described in our new paper [ NewFC](http://research.microsoft.com/en-us/um/people/simonpj/papers/ext-f/).
...
- **Edward Yang** has spearheaded a flurry of work on the new
  ...
  fully part of GHC [ http://research.microsoft.com/en-us/um/people/simonpj/papers/c--/ Hoopl](http://research.microsoft.com/en-us/um/people/simonpj/papers/c--/ Hoopl), and the new path uses it extensively; we’ve
...
- \[Cloud\] "Haskell for the cloud", Epstein, Black, Peyton Jones, submitted to ICFP 2011, [ http://research.microsoft.com/en-us/um/people/simonpj/papers/parallel/](http://research.microsoft.com/en-us/um/people/simonpj/papers/parallel/)
...
- \[DetPar\] "A monad for deterministic parallelism", Marlow, Newton, and Peyton Jones, submitted to ICFP 2011, [ http://research.microsoft.com/en-us/um/people/simonpj/papers/parallel/](http://research.microsoft.com/en-us/um/people/simonpj/papers/parallel/)

- \[FC\] "System F with type equality coercions", Sulzmann, Chakravarty, Peyton Jones, TLDI 2007, [ http://research.microsoft.com/en-us/um/people/simonpj/papers/ext-f/](http://research.microsoft.com/en-us/um/people/simonpj/papers/ext-f/)

- \[Hoopl\] "A modular, reusable library for dataflow analysis and transformation", Dias, Ramsey, and Peyton Jones, Haskell Symposium 2010, [ http://research.microsoft.com/en-us/um/people/simonpj/papers/c--/](http://research.microsoft.com/en-us/um/people/simonpj/papers/c--/)

- \[ImprovingSupercompilation\] "Improving supercompilation: tag-bags, rollback, speculation, normalisation, and generalisation", Bolingbroke and Peyton Jones, submitted to ICFP 2011, [ http://research.microsoft.com/en-us/um/people/simonpj/papers/supercompilation/](http://research.microsoft.com/en-us/um/people/simonpj/papers/supercompilation/)

- \[NewFC\] "Practical aspects of evidence-based compilation in System FC", Vytiniotis and Peyton Jones, submitted to ICFP 2011, [ http://research.microsoft.com/en-us/um/people/simonpj/papers/ext-f/](http://research.microsoft.com/en-us/um/people/simonpj/papers/ext-f/)

- \[OutsideIn\] "Modular type inference iwth local assumptions", Vytiniotis, Peyton Jones, Schrijvers, and Sulzmann, Journal of Functional Programming (to appear), [ http://research.microsoft.com/en-us/um/people/simonpj/papers/constraints/](http://research.microsoft.com/en-us/um/people/simonpj/papers/constraints/)
...
- \[Repa\] "Regular, shape-polymorphic parallel arrays in Haskell", Keller, Chakravarty, Leshchinskiy, Peyton Jones, and Lippmeier, ICFP 2010.  Paper: [ http://research.microsoft.com/en-us/um/people/simonpj/papers/ndp/](http://research.microsoft.com/en-us/um/people/simonpj/papers/ndp/), Hackage package: [ http://hackage.haskell.org/package/repa](http://hackage.haskell.org/package/repa)
