 ...
 * `TypeInType` was a major increment, and we are still refactoring type inference to account for it in a robust, modular way.  GHC 8.8 has a lot of consolidation in this area, especially of kind inference for type and class declarations.  
