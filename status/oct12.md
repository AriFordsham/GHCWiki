...
\[10\] Holes in GHC:  [https://gitlab.haskell.org/trac/ghc/wiki/Holes](https://gitlab.haskell.org/trac/ghc/wiki/Holes)
\[11\] Overlapping type family instances: [https://gitlab.haskell.org/trac/ghc/wiki/NewAxioms](https://gitlab.haskell.org/trac/ghc/wiki/NewAxioms)
\[12\] Matching on type nats: [https://gitlab.haskell.org/trac/ghc/wiki/TypeNats/MatchingOnNats](https://gitlab.haskell.org/trac/ghc/wiki/TypeNats/MatchingOnNats)
\[13\] Singletons and kinds: [https://gitlab.haskell.org/trac/ghc/wiki/TypeNats/SingletonsAndKinds](https://gitlab.haskell.org/trac/ghc/wiki/TypeNats/SingletonsAndKinds)
