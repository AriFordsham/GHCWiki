...
Life still goes on, and current HEAD version [ http://darcs.haskell.org/ghc/](http://darcs.haskell.org/ghc/), that will ultimately become GHC 6.8, already includes significant new features:
