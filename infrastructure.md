...
- We can quickly install different versions of GHC with these [ https://launchpad.net/\~hvr/+archive/ubuntu/ghc Ubuntu packages](https://launchpad.net/~hvr/+archive/ubuntu/ghc Ubuntu packages).
