...
<table><tr><th><a href="http://code.haskell.org/repa/repa-head/repa-examples/MMult/"> MMult</a></th>
<td>
...
<table><tr><th><a href="http://code.haskell.org/repa/repa-head/repa-examples/Laplace/"> Laplace</a> <b>(SLOWLORIS)</b></th>
<td>
...
<table><tr><th><a href="http://code.haskell.org/repa/repa-head/repa-examples/Blur/"> Blur</a></th>
<td>
...
<table><tr><th><a href="http://code.haskell.org/repa/repa-head/repa-examples/EdgeDetect/"> EdgeDetect</a></th>
<td>
...
<table><tr><th><a href="http://code.haskell.org/repa/repa-head/repa-examples/FFT/"> FFT</a></th>
<td>
...
<table><tr><th><a href="http://darcs.haskell.org/packages/dph/dph-examples/imaginary/SumSquares/"> SumSquares</a></th>
<td>
Computes the sum of the squares from 1 to N using <tt>Int</tt>.  N = 100M.
</td></tr></table>
...
<table><tr><th><a href="http://darcs.haskell.org/packages/dph/dph-examples/imaginary/DotProduct"> DotProduct</a></th>
<td>
Computes the dot product of two vectors of <tt>Double</tt>s. N=10M.
</td></tr></table>
...
<table><tr><th><a href="http://darcs.haskell.org/libraries/dph/dph-examples/imaginary/Evens/"> Evens</a></th>
<td>
Takes the even valued <tt>Int</tt>s from a vector. N=10M.
</td></tr></table>
...
> - rl reckons the slowdown is due to GHC compiling modulo of powers of two inefficiently; c.f., #3065 (in `packByTags`)
>
>
...
<table><tr><th><a href="http://darcs.haskell.org/packages/dph/examples/smvm/"> SMVM</a> <b>(BROKEN)</b></th>
<td>
Multiplies a dense vector with a sparse matrix represented in the <i>compressed sparse row format (CSR).</i> <br>
</td></tr></table>
...
<table><tr><th><a href="http://darcs.haskell.org/packages/dph/examples/primes/"> Primes</a></th>
<td>
The Sieve of Eratosthenes using parallel writes into a sieve structure represented as an array of <tt>Bool</tt>s.  
</td></tr></table>
...
<table><tr><th><a href="http://darcs.haskell.org/libraries/dph/dph-examples/spectral/QuickSort/"> QuickSort</a> <b>(BROKEN) (SLOWDOWN)</b></th>
<td>
...
<table><tr><th><a href="http://darcs.haskell.org/libraries/dph/dph-examples/spectral/QuickHull/"> Quickhull</a> <b>(SLOWLORIS)</b></th>
<td>
...
<table><tr><th><a href="http://darcs.haskell.org/libraries/dph/dph-examples/imaginary/Words/"> Words</a> <b>(BROKEN)</b></th>
<td>
...
>
>
> **Status**: Sequential vectorised version does not compile due to loop in SpecConstr (#4831). LLVM versions take \>10 min to compile (#4838)
>
...
<table><tr><th><a href="http://darcs.haskell.org/libraries/dph/dph-examples/real/NBody/"> BarnesHut</a> <b>(BROKEN)</b> <b>(SLOWLORIS)</b></th>
<td>
This benchmark implements the Barnes-Hut algorithm to solve the <i>n</i>-body problem in two dimensions. There is a naive O(n<sup>2</sup>) version in the same package.
</td></tr></table>
...
>
>
> **Status**:  -fasm vesions compile but fusion doesn't work so it's very slow. LLVM versions take 30min to compile (#4838) 
>
