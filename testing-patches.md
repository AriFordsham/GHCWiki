...
- **`--fast`**:  validate skips the build-a-distribution step, does not build the 'extra' packages (`BUILD_EXTRA_PKGS=NO`, see [Building/Using](building/using#build-configuration)). 
