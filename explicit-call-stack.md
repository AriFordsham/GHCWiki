...
2.  But that doesn't help with 'head'.  We want to pass head's site to head. That's what jhc does when you give 'head' the a magic [http://repetae.net/john/computer/jhc/jhc.html SRCLOC_ANNOTATE pragma]:
