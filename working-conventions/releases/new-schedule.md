...
Currently, many libraries have a three GHC versions support policy: [https://gitlab.haskell.org/haskell/prime/-/wikis/libraries/3-release-policy](https://gitlab.haskell.org/haskell/prime/-/wikis/libraries/3-release-policy). If there are more frequent GHC versions, this may lead to shorter support times of these libraries.
