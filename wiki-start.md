...
- Forthcoming planned releases:
  ...
  - [8.6.1](status/ghc-8.6.1) (7 (Ticket query: status: !closed, status: !merge, priority: high, priority: highest, milestone: 8.6.1, max: 0, order: id)[ open tickets](https://ghc.haskell.org/trac/ghc/query?status=!closed&priority=high&priority=highest&milestone=8.6.1&order=priority) with priority high or highest) 
