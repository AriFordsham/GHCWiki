...
file, which is generated by `configure` from [ project.mk.in](http://darcs.haskell.org/ghc/mk/project.mk.in), defines several symbols related to the platform settings.
