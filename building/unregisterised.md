...
GHC will automatically do an unregisterised build on platforms that it knows don't currently have registerised support. See the variable `UnregisterisedDefault` in [configure.ac](https://gitlab.haskell.org/ghc/ghc/tree/master/configure.ac)[](/trac/ghc/export/HEAD/ghc/configure.ac).
