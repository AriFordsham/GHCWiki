...
The 64-bit MinGW-w64 version of `curl` is known to fail (see [ this issue](https://github.com/Alexpux/MINGW-packages/issues/1707)) when used with the `mk/get-win32-tarballs.sh` script:
