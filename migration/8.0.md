...
>
> The [ hackage:semigroup](http://hackage.haskell.org/package/semigroup) package can be used to avoid `-XCPP` usage by providing the same `Data.Semigroup` module for older GHCs.
