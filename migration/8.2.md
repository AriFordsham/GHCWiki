...
```
typeT ty1 v ty2 =...-- 'ty1' for 'a'-- 'ty2' for 'b', and-- a variable for 'x'
```
...
```
instanceCIntCharwheretypeTIntBoolChar=BooltypeTInt()Char=()typeTInt v    Char= v
```
...
```
instanceCIntCharwheretypeTInt v Char=CIntChar v

typefamilyCIntChar v whereCIntCharBool=BoolCIntChar()=()CIntChar v    = v
```
