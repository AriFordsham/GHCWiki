...
These settings are made in [ghc/.travis.yml](https://gitlab.haskell.org/ghc/ghc/tree/master/ghc/.travis.yml)[](/trac/ghc/export/HEAD/ghc/.travis.yml). You can conveniently experiment with different settings in a `wip/...` branch.
