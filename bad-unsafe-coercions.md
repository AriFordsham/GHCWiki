...
1. If types are unlifted then their *size* should be equal, see `primRepSizeW` in [source:compiler/types/TyCon.hs](https://gitlab.haskell.org/ghc/ghc/tree/master/compiler/types/TyCon.hs)[](/trac/ghc/export/HEAD/ghc/compiler/types/TyCon.hs)
...
in Vectors, see `primElemRepSizeB` in ([source:compiler/types/TyCon.hs](https://gitlab.haskell.org/ghc/ghc/tree/master/compiler/types/TyCon.hs)[](/trac/ghc/export/HEAD/ghc/compiler/types/TyCon.hs)). The reasons about forbidding coercions between
