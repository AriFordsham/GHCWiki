...
Error: HttpError (HttpExceptionRequest Request {
  ...
  secure               = True
  requestHeaders       = []
  path                 = "/trac/ghc/wiki/Attic/Building/BuildSystem"
 ...
 * The last section includes a second file of standard
   ...
   to make the standard targets ([wiki:Building/Using#StandardTargets standard targets]).  Why, you ask, can't this
