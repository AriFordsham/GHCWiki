...
The \[Core Libraries Committee\]([ https://wiki.haskell.org/Core_Libraries_Committee](https://wiki.haskell.org/Core_Libraries_Committee)) is responsible for developing the core libraries that ship with GHC.  This is an important but painstaking task, and we owe the CLC a big vote of thanks for taking it on.
