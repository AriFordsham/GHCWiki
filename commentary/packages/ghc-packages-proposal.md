...
This page summarises our current proposal for packages in GHC. See also [wiki:GhcPackageNamespaces an extended proposal] to make namespaces first-class.
