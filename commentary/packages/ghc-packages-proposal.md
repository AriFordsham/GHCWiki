...
This page summarises our current proposal for packages in GHC. (See also [wiki:GhcPackageNamespaces an extended proposal] to make namespaces first-class, and [wiki:PackageMounting a proposal] for package mounting. The three proposals are mutually exclusive.)
...
The remaining question is this: '''When you say {{{import A.B.C}}}, from what package does A.B.C come?'''.  Three alternatives are under consideration:
  ...
  * Plan C: grafting.  See [wiki:PackageMounting Frederik Eaton's proposal]
