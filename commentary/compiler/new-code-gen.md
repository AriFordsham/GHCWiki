...
- Compiling through the new pipeline passes all tests and GHC is bootstrappable. There is a [ patch pending for a pointer tagging bug that manifests under rare conditions with the compacting GC](http://comments.gmane.org/gmane.comp.lang.haskell.cvs.ghc/45499).
