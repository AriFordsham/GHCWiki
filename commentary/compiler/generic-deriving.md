...
The ticket for this request is [\#5462](https://gitlab.haskell.org//ghc/ghc/issues/5462). For this discussion, we'll refer to this new feature as `GeneralizedDeriving`.
