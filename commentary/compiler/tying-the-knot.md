...
Use Keyword = `hs-boot` to ensure that a ticket ends up on one of these lists.

[Open Tickets](https://gitlab.haskell.org/ghc/ghc/issues?scope=all&utf8=%E2%9C%93&state=opened&label_name[]=hs-boot)

[Closed Tickets](https://gitlab.haskell.org/ghc/ghc/issues?scope=all&utf8=%E2%9C%93&state=closed&label_name[]=hs-boot)
