...
Expressions are type checked by [compiler/typecheck/TcExpr.hs](https://gitlab.haskell.org/ghc/ghc/blob/master/compiler/typecheck/TcExpr.hs).
...
This sounds simple enough; however, the actual implementation is a bit more tricky as it wants to keep track of all the instances at which overloaded functions are used in a module. This information is useful to optimise the code. The implementation is the module [compiler/typecheck/Inst.hs](https://gitlab.haskell.org/ghc/ghc/blob/master/compiler/typecheck/Inst.hs).
