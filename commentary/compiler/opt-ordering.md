...
This page has notes about the ordering of optimisation phases. An overview of the whole Core-to-Core optimisation pipeline can be found [here](commentary/compiler/core-to-core-pipeline).
