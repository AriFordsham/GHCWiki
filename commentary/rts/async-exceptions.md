...
Error: HttpError (HttpExceptionRequest Request {
  ...
  secure               = True
  requestHeaders       = []
  path                 = "/trac/ghc/wiki/Commentary/Rts/AsyncExceptions"
