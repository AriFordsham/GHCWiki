...
For all the details on how SRTs work, see `Note [SRTs]` in [compiler/cmm/CmmBuildInfoTables.hs](https://gitlab.haskell.org/ghc/ghc/blob/master/compiler/cmm/CmmBuildInfoTables.hs).
