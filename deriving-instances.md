...
<table><tr><th>[\#1544](https://gitlab.haskell.org//ghc/ghc/issues/1544)</th>
...
<table><tr><th>[\#1356](https://gitlab.haskell.org//ghc/ghc/issues/1356)</th>
<td>"derive instance" panics ghc-6.7.20070404</td></tr>
<tr><th>[\#1830](https://gitlab.haskell.org//ghc/ghc/issues/1830)</th>
<td>Automatic derivation of Lift</td></tr>
<tr><th>[\#2721](https://gitlab.haskell.org//ghc/ghc/issues/2721)</th>
<td>Newtype deriving doesn't work with type families</td></tr>
<tr><th>[\#2733](https://gitlab.haskell.org//ghc/ghc/issues/2733)</th>
<td>Newtype deriving over phantom types broke between GHC 6.6.1 and GHC 6.8.1</td></tr>
<tr><th>[\#2734](https://gitlab.haskell.org//ghc/ghc/issues/2734)</th>
<td>Newtype deriving over phantom types broke between GHC 6.6.1 and GHC 6.8.1</td></tr>
<tr><th>[\#3368](https://gitlab.haskell.org//ghc/ghc/issues/3368)</th>
<td>Deriving Foldable doesn't work</td></tr>
<tr><th>[\#3422](https://gitlab.haskell.org//ghc/ghc/issues/3422)</th>
<td>No match in record selector Var.tcTyVarDetails</td></tr>
<tr><th>[\#4019](https://gitlab.haskell.org//ghc/ghc/issues/4019)</th>
<td>deriving Ord can produce incorrect and inefficient instances</td></tr>
<tr><th>[\#4028](https://gitlab.haskell.org//ghc/ghc/issues/4028)</th>
<td>Derived Data instance requires Data instances for unused type parameters</td></tr>
<tr><th>[\#4235](https://gitlab.haskell.org//ghc/ghc/issues/4235)</th>
<td>deriving Enum fails for data instances</td></tr>
<tr><th>[\#4309](https://gitlab.haskell.org//ghc/ghc/issues/4309)</th>
<td>Painfully large errors with silly GADT instances</td></tr>
<tr><th>[\#4528](https://gitlab.haskell.org//ghc/ghc/issues/4528)</th>
<td>stand-alone deriving sometimes fails for GADTs</td></tr>
<tr><th>[\#4529](https://gitlab.haskell.org//ghc/ghc/issues/4529)</th>
<td>Deriving Data does not work for attached code</td></tr>
<tr><th>[\#4530](https://gitlab.haskell.org//ghc/ghc/issues/4530)</th>
<td>Deriving Data for existentially quantified types</td></tr>
<tr><th>[\#4815](https://gitlab.haskell.org//ghc/ghc/issues/4815)</th>
...
<tr><th>[\#7199](https://gitlab.haskell.org//ghc/ghc/issues/7199)</th>
...
<tr><th>[\#7742](https://gitlab.haskell.org//ghc/ghc/issues/7742)</th>
<td>StandaloneDeriving on Read fails for GADTs</td></tr>
<tr><th>[\#8128](https://gitlab.haskell.org//ghc/ghc/issues/8128)</th>
<td>Standalone deriving fails for GADTs due to inaccessible code</td></tr>
<tr><th>[\#8165](https://gitlab.haskell.org//ghc/ghc/issues/8165)</th>
<td>Use GeneralizedNewtypeDeriving to automatically create associated type families</td></tr>
<tr><th>[\#8263](https://gitlab.haskell.org//ghc/ghc/issues/8263)</th>
...
<tr><th>[\#8740](https://gitlab.haskell.org//ghc/ghc/issues/8740)</th>
<td>Deriving instance conditionally compiles</td></tr>
<tr><th>[\#9444](https://gitlab.haskell.org//ghc/ghc/issues/9444)</th>
...
<tr><th>[\#9850](https://gitlab.haskell.org//ghc/ghc/issues/9850)</th>
...
<tr><th>[\#10447](https://gitlab.haskell.org//ghc/ghc/issues/10447)</th>
<td>DeriveFoldable rejects instances with constraints in last argument of data type</td></tr>
<tr><th>[\#10524](https://gitlab.haskell.org//ghc/ghc/issues/10524)</th>
<td>PolyKinds doesn't interact well with DeriveFunctor</td></tr>
<tr><th>[\#10561](https://gitlab.haskell.org//ghc/ghc/issues/10561)</th>
<td>"deriving (Functor)" on a polykinded type produces ill-kinded instance</td></tr>
<tr><th>[\#10577](https://gitlab.haskell.org//ghc/ghc/issues/10577)</th>
...
<tr><th>[\#10607](https://gitlab.haskell.org//ghc/ghc/issues/10607)</th>
<td>Auto derive from top to bottom</td></tr>
<tr><th>[\#10835](https://gitlab.haskell.org//ghc/ghc/issues/10835)</th>
<td>Regression in standalone Data deriving for phantom types</td></tr>
<tr><th>[\#10858](https://gitlab.haskell.org//ghc/ghc/issues/10858)</th>
<td>Smaller generated Ord instances</td></tr>
<tr><th>[\#10859](https://gitlab.haskell.org//ghc/ghc/issues/10859)</th>
<td>Generated Eq instance associates && wrongly</td></tr>
<tr><th>[\#10938](https://gitlab.haskell.org//ghc/ghc/issues/10938)</th>
<td>DeriveAnyClass + deriving Bifunctor causes GHC panic</td></tr>
<tr><th>[\#11174](https://gitlab.haskell.org//ghc/ghc/issues/11174)</th>
<td>Traversable can't be derived for datatypes with unboxed arguments</td></tr>
<tr><th>[\#11396](https://gitlab.haskell.org//ghc/ghc/issues/11396)</th>
<td>deriving Ix with custom ifThenElse causes "Bad call to tagToEnum\#"</td></tr>
<tr><th>[\#11509](https://gitlab.haskell.org//ghc/ghc/issues/11509)</th>
<td>Incorrect error message in StandaloneDeriving: "The data constructors of \<typeclass\> are not all in scope"</td></tr>
<tr><th>[\#11837](https://gitlab.haskell.org//ghc/ghc/issues/11837)</th>
<td>GHC fails to unify kinds when deriving polykinded typeclass instance for polykinded newtype</td></tr>
<tr><th>[\#12047](https://gitlab.haskell.org//ghc/ghc/issues/12047)</th>
<td>Users Guide: GeneralizedNewtypeDeriving derives “instance Num Int =\> Num Dollars”</td></tr>
<tr><th>[\#12080](https://gitlab.haskell.org//ghc/ghc/issues/12080)</th>
<td>RebindableSyntax breaks deriving Ord</td></tr>
<tr><th>[\#12234](https://gitlab.haskell.org//ghc/ghc/issues/12234)</th>
<td>'deriving Eq' on recursive datatype makes ghc eat a lot of CPU and RAM</td></tr>
<tr><th>[\#12399](https://gitlab.haskell.org//ghc/ghc/issues/12399)</th>
<td>DeriveFunctor fail</td></tr>
<tr><th>[\#12438](https://gitlab.haskell.org//ghc/ghc/issues/12438)</th>
<td>DeriveDataTypeable - deriving instance Data (Mu (Const ()))</td></tr>
<tr><th>[\#12439](https://gitlab.haskell.org//ghc/ghc/issues/12439)</th>
...
<tr><th>[\#13263](https://gitlab.haskell.org//ghc/ghc/issues/13263)</th>
...
<tr><th>[\#13324](https://gitlab.haskell.org//ghc/ghc/issues/13324)</th>
...
<tr><th>[\#13759](https://gitlab.haskell.org//ghc/ghc/issues/13759)</th>
...
<tr><th>[\#14094](https://gitlab.haskell.org//ghc/ghc/issues/14094)</th>
...
<tr><th>[\#14357](https://gitlab.haskell.org//ghc/ghc/issues/14357)</th>
<td>Document deriving strategies fully</td></tr>
<tr><th>[\#14364](https://gitlab.haskell.org//ghc/ghc/issues/14364)</th>
<td>Reduce repetition in derived Read instances</td></tr>
<tr><th>[\#14365](https://gitlab.haskell.org//ghc/ghc/issues/14365)</th>
<td>Panic with (bogus?) deriving in hs-boot: newTyConEtadArity</td></tr>
<tr><th>[\#14462](https://gitlab.haskell.org//ghc/ghc/issues/14462)</th>
<td>deriving on associated data types fails to find constraints</td></tr>
<tr><th>[\#14578](https://gitlab.haskell.org//ghc/ghc/issues/14578)</th>
<td>Incorrect parenthesization of types in -ddump-deriv</td></tr>
<tr><th>[\#14579](https://gitlab.haskell.org//ghc/ghc/issues/14579)</th>
<td>GeneralizedNewtypeDeriving produces ambiguously-kinded code</td></tr>
<tr><th>[\#14661](https://gitlab.haskell.org//ghc/ghc/issues/14661)</th>
<td>Cannot derive (newtype I a b = I (F a -\> F b) deriving newtype Category) for type family F</td></tr>
<tr><th>[\#14682](https://gitlab.haskell.org//ghc/ghc/issues/14682)</th>
<td>Atrocious parenthesization in -ddump-deriv output</td></tr>
<tr><th>[\#14692](https://gitlab.haskell.org//ghc/ghc/issues/14692)</th>
<td>Deriving Show with -XEmptyDataDeriving cases on the wrong argument</td></tr>
<tr><th>[\#14728](https://gitlab.haskell.org//ghc/ghc/issues/14728)</th>
...
<tr><th>[\#14916](https://gitlab.haskell.org//ghc/ghc/issues/14916)</th>
<td>Missing checks when deriving special classes</td></tr>
<tr><th>[\#14918](https://gitlab.haskell.org//ghc/ghc/issues/14918)</th>
<td>GHC 8.4.1 regression: derived Read instances with field names containing \# no longer parse</td></tr>
<tr><th>[\#14932](https://gitlab.haskell.org//ghc/ghc/issues/14932)</th>
<td>DeriveAnyClass produces unjustifiably untouchable unification variables</td></tr>
<tr><th>[\#14933](https://gitlab.haskell.org//ghc/ghc/issues/14933)</th>
<td>DeriveAnyClass can cause "No skolem info" GHC panic</td></tr>
<tr><th>[\#15012](https://gitlab.haskell.org//ghc/ghc/issues/15012)</th>
<td>"Iface type variable out of scope" when compiling with -c</td></tr>
<tr><th>[\#15073](https://gitlab.haskell.org//ghc/ghc/issues/15073)</th>
