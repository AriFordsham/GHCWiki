...
Some of those operations can also be performed via the *Admin* web interface, an updated version of the [ WebAdmin](http://trac.edgewall.org/wiki/WebAdmin) plugin now integrated within Trac (since version 0.11).
