...
Haddock comment support was added to GHC as part of a [ Google Summer Of Code](http://code.google.com/soc) project aiming to port the existing Haddock program to use the GHC API. Thus, GHC understands Haddock comments and they are available through the GHC API.
