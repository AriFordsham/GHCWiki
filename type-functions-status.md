...
'''Current:'''
 0. For Tom: Construct `TyCon` for type equation in `tcFamInstDecl1`.  This needs to be a synonym tycon, which still needs to be extended to include family information.
